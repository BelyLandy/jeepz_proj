...
public class PlayerAnimController_CC : MonoBehaviour
{
    [Header("Refs")]
    [SerializeField] private Animator animator;
    [SerializeField] private KinematicHero25DRotationDriver rotationAnim;
    ...
    void Reset()
    {
        rotationAnim = GetComponent<KinematicHero25DRotationDriver>();
        if (animator == null)
