...
public class LockWorldRotation : MonoBehaviour
{
    ...
    // Кэш предыдущего состояния, чтобы не дергать лишние присваивания
    ...
    {
        // Присваиваем только если реально отличается (микроэкономия)
    ...
    private void ApplyFlipX()
    {
        ...
        // Хистерезис: если уже зафлиплено — отпускаем только когда угол < (threshold - hysteresis)
        bool shouldFlip;
    ...
    // На случай смены родителя в рантайме
