...
public class ClothArcShooter : MonoBehaviour
{
    ...
    {
        // Глубина до плоскости ткани по направлению камеры
        ...
        // Spawn на плоскости ткани (по XY), а Z сам снаряд выставит "перед тканью" в Init()
        Vector3 w = cam.ViewportToWorldPoint(new Vector3(vx, vy, depthToCloth));
        w.z = clothZ; // init снаряда сам сместит в -zInFrontOfCloth
        return w;
    }
}
