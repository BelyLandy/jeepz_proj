...
public class FaceOnPressSmooth : MonoBehaviour
{
    ...
    public float deadzone = 0.01f;              // игнор мелких дрожаний оси

    [Header("Углы")]
    public float rightYaw = 0f;                 // смотрит вправо
    public float leftYaw = 180f;                // смотрит влево
    ...
    void Update()
    {
        ...
        // фиксируем цель ТОЛЬКО когда появляется уверенный ввод влево/вправо
    ...
    // опционально: внешнее API, чтобы заставить смотреть в сторону сразу с плавным доворотом
